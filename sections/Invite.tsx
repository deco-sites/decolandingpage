  ...
  return (
    <div id="Invite" className={"bg-[#06E474]"}>
      ...
      >
        ...
        >
          <span class="absolute -right-10 w-20 h-60 -mt-12 transition-all duration-500 transform translate-x-12 bg-white opacity-5 rotate-12 group-hover:-translate-x-[800px] ease">
          </span>
