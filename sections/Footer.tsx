...
export default function Footer({ footerTitle, descriptionTitle, imageDescription, seedText }: props) {
  return (
    <div id="footer">
      <div className={"flex items-center flex-col justify-center w-[90%] mx-auto"}>
        <h2
        ...
        <div className={"flex flex-col items-center"}>
            ...
            <p className={"text-[16px] text-[#f3fff9] font-[400] text-center mb-[30px] lg:mb-[46px]"}>{imageDescription}</p>
        </div>
        <div className={"flex flex-row justify-center mb-[10px] lg:mb-[14px] gap-[20px]"}>
        ...
        <p className={"text-[16px] text-[#f3fff9] font-[400] text-center mb-[40px] lg:mb-[64px]"}>{seedText}</p>
      </div>
    </div>
  );
}
